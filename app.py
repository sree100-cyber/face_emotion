...
def load_emotion_model():
    model_path = os.path.join(os.path.dirname(__file__), "emotion_model_final.h5")
    if not os.path.exists(model_path):
        st.error(" Model file not found! Please ensure 'emotion_model_final.h5' is in the same folder as app.py.")
        st.stop()
